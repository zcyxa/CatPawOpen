export default {
  ...
  bili: {
      categories:
          "新闻#资讯#影视#电影#电视剧#纪录片#探索发现超清#儿童#音乐#无损音乐合集#先锋老刘#知识",
      cookie: "",
  },
  uc: {
      cookie: "",
  ...
  live: {
      //      contents: 'https://gitee.com/qarclub/playlist/raw/master/contents.txt', //安地区分类
      url: [
          {
              name: "iptv",
              url: "https://gitee.com/qarclub/playlist/raw/master/tv.list",
              index: "true",
          },
          {
              name: "咪咕",
          ...
          //{ name: 'live-cat', url: 'https://live.catvod.com/tv.m3u', index: 'true' },
          {
              name: "iptv-cat ",
